            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    >
                        ...
                        >
                            <ReactApexChart options={chart3.options} series={chart3.series} type="bar" height={350} />
                        </div>
                    </div>
                    <div id="Packet-chart-container">
                        <div id="chart">
                    ...
                    >
                        ...
                        >
                            <ReactApexChart options={chart5.options} series={chart5.series} type="radar" height={350} />
                        </div>
                        <div
                            id="at_risk"
                            style={{
                        ...
                        >
                            <ReactApexChart options={chart6.options} series={chart6.series} type="pie" height={350} />
                        </div>
                    </div>
                </main>
            </div>
